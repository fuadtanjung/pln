            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('update.pengaduan_ti', $id_pengaduan_ti)}}" method="POST" enctype="multipart/form-data" id="form_pengaduan_ti">
                                @csrf
                                @method('PATCH')
                                <div class="form-group">
                                    ...
                                    <select name="master_select" class="form-control" id="id_master_ti">
                                        ...
                                        <option value="{{$master->id_master_ti}}" {{ $master->id_master_ti == $detail_pengaduan_ti->id_master_ti ? 'selected' : '' }}>{{$master->nama_master_ti}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"  id="edit_tgl_pengaduan" value="{{ $detail_pengaduan_ti->pengaduan_aset_ti->tgl_pengaduan }}" class="form-control" id="tgl_pengaduan" name="tgl_pengaduan">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('img/' .$detail_pengaduan_ti->foto) }}" width="300" height="350">
                                    <br>
                                    <br>
                                ...
                                <div class="form-group">
                                   ...
                                   > {{ $detail_pengaduan_ti->keterangan }}</textarea>
                                </div>
                                <div class="form-group">
