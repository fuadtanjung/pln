                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group form-inline">
                                       ...
                                       {{ $detail_pengaduan_jaringan->master_aset_jaringan->nama_master_jaringan}}
                                    ...
                                    <div class="form-group form-inline">
                                        ...
                                        <label for="" class="col-md-2 ">:</label>
                                        {{$detail_pengaduan_jaringan->pengaduan_aset_jaringan->tgl_pengaduan}}
                                        <div for="inlineinput" class="col-md-4 ">
                                        </div>
                                    </div>
                                    <div class="form-group form-inline" >
                                    ...
                                    <div class="form-group form-inline" >
                                        <label for="inlineinput" class="col-md-6">Tanggapan</label>
                                        <label for="" class="col-md-2 ">:</label>
                                        <p id="tanggapan" name="tanggapan"rows="5" cols="110">
                                            <br>
                                        {{$detail_pengaduan_jaringan->tanggapan}}
                                        </p >
                                        <div for="inlineinput" class="col-md-4 " readonly>
                                        </div>
                                    </div>
